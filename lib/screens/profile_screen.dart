    ...
    return WillPopScope(
      ...
      child: StreamBuilder<List<Course>>(
          ...
          builder: (context, snapshot) {
            ...
            Provider.of<FireStoreUni>(context).courses = snapshot.data;
            return InnerDrawer(
              key: _innerDrawerKey,
              onTapClose: true,
              swipe: true,
                        ...
                        children: <Widget>[
                          ...
                          if (x == 0)
                            Column(children: <Widget>[
                              Text(
                                'List of Courses',
                                style: TextStyle(fontWeight: FontWeight.w800, color: Colors.black54, fontSize: 40),
                              ),
                              Container(
                                              ...
                                              child: Material(
                                                ...
                                                child: Container(
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: <Widget>[
                                                      Text(
                                                        Provider.of<FireStoreUni>(context).courses[index].Id.toString(),
                                                        style: TextStyle(color: Colors.black54, fontWeight: FontWeight.w800, fontSize: 15),
                                                      ),
                                                      Text(
                                                        Provider.of<FireStoreUni>(context).courses[index].Name,
                                                      ...
                                                      Row(
                                                        ...
                                                        children: <Widget>[
                                                          ...
                                                          Text(
                                                            Provider.of<FireStoreUni>(context).courses[index].Credits.toString(),
                                                          ...
                                                          Text(
                                                            Provider.of<FireStoreUni>(context).courses[index].Seats.toString(),
                                                            style: TextStyle(color: Colors.black54, fontWeight: FontWeight.w500, fontSize: 15),
                                                          ),
                                                        ],
                                                      ),
                                                      Row(
                                                        ...
                                                        children: <Widget>[
                                                          ...
                                                          Text(
                                                            Provider.of<FireStoreUni>(context).courses[index].Faculty_Id.toString(),
                                                ...
                                                child: Material(
                                                  ...
                                                  child: Container(
                                                    ...
                                                    child: Column(
                                                      ...
                                                      children: <Widget>[
                                                        Text(
                                                          Provider.of<FireStoreUni>(context).students[index].Name +
                                                              ' - ' +
                                                              Provider.of<FireStoreUni>(context).students[index].Id.toString(),
                                                          style: TextStyle(color: Colors.white, fontWeight: FontWeight.w800, fontSize: 20),
                                                        ),
                                                        Row(
                                                          mainAxisAlignment: MainAxisAlignment.center,
                                                          children: <Widget>[
                                                            ...
                                                            Text(
                                                              Provider.of<FireStoreUni>(context).students[index].Phone,
                                                              style: TextStyle(color: Colors.black54, fontWeight: FontWeight.w500, fontSize: 15),
                                                            )
                                                          ],
                                                        ),
                                                        Row(
                                                          ...
                                                          children: <Widget>[
                                                            ...
                                                            Text(
                                                              Provider.of<FireStoreUni>(context).students[index].Email,
                                                              style: TextStyle(color: Colors.black54, fontWeight: FontWeight.w500, fontSize: 15),
                                                            ),
                                                          ],
                                                        )
                      ...
                      children: <Widget>[
                        if (x == 0)
                          Text(
                            ...
                            style: TextStyle(fontSize: 50, color: Colors.black54, fontWeight: FontWeight.w600, letterSpacing: 10),
                          ),
                        if (x == 2)
                          StreamBuilder<List<Student>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                return Text(
                                  ...
                                  style: TextStyle(fontSize: 50, color: Colors.blueAccent, fontWeight: FontWeight.w600, letterSpacing: 10),
                                );
                              }),
                        SizedBox(
                          height: 10,
                          ...
                          child: Container(
                            ...
                            child: Padding(
                              ...
                              child: Material(
                                ...
                                child: Container(
                                  decoration: BoxDecoration(
                                      border: Border.all(color: Colors.white54), color: Colors.white, borderRadius: BorderRadius.circular(25.0)),
                                  child: Column(
                                    mainAxisAlignment: MainAxisAlignment.center,
                                    crossAxisAlignment: CrossAxisAlignment.center,
                                    children: <Widget>[
                                      ...
                                      if (x == 0)
                                        Text(student.Name, style: TextStyle(fontSize: 25, color: Colors.blueAccent, fontWeight: FontWeight.w600)),
                                      if (x == 2)
                                        Text(faculty.Name, style: TextStyle(fontSize: 25, color: Colors.blueAccent, fontWeight: FontWeight.w600)),
                                      SizedBox(height: 10),
                                      if (x == 0)
                                        Text(student.Email, style: TextStyle(fontSize: 25, color: Colors.blueAccent, fontWeight: FontWeight.w600)),
                                      if (x == 2)
                                        Text(faculty.Email, style: TextStyle(fontSize: 25, color: Colors.blueAccent, fontWeight: FontWeight.w600)),
                                      SizedBox(height: 10),
                                      if (x == 0)
                                        Text(student.Phone, style: TextStyle(fontSize: 25, color: Colors.blueAccent, fontWeight: FontWeight.w600)),
                                      if (x == 2)
                                        Text(faculty.Phone, style: TextStyle(fontSize: 25, color: Colors.blueAccent, fontWeight: FontWeight.w600)),
                                      SizedBox(height: 10),
                                      if (x == 0)
                                        StreamBuilder<List<Degree>>(
                                            ...
                                            builder: (context, snapshot) {
                                              ...
                                              var len = snapshot.data.length;
                                              for (var i = 0; i < len; ++i) {
                                                var length = snapshot.data[i].Student_Ids.length;
                                                for (var j = 0; j < length; ++j) {
                                                  if (snapshot.data[i].Student_Ids[j] == student.Id) {
                        ...
                        if (x == 2)
                          Text(
                            'Students teached by the faculty : ' + course.Student_Ids.length.toString(),
                            style: TextStyle(fontSize: 20, color: Colors.black54),
                          ),
                        if (x == 0)
                          Text(
