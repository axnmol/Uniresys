                                                            ...
                                                            children: <Widget>[
                                                              ...
                                                              Row(
                                                                ...
                                                                children: <Widget>[
                                                                  ...
                                                                  Text(
                                                                    courseList[index].Credits.toString(),
                                                                  ...
                                                                  Text(
                                                                    courseList[index].Seats.toString(),
                                                                    style: TextStyle(color: Colors.black54, fontWeight: FontWeight.w500, fontSize: 15),
                                                                  ),
                                                                ],
                                                              ),
                                                              Row(
                                                                ...
                                                                children: <Widget>[
                                                                  ...
                                                                  Text(
                                                                    courseList[index].Faculty_Id.toString(),
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            if (x == 0)
                              Text(
                                'Courses enrolled by a student : ' + courseList.length.toString(),
                            ...
                            if (x == 0)
                              Text(
                                'Credits attained by a student : ' + countCredits(courseList),
                                style: TextStyle(fontSize: 20, color: Colors.black54),
                              ),
                            SizedBox(
                              height: 15,
